...
import {Profile, ProfileList, UpdatedProfile} from './Keywords';
import {ListIcon, ProfileIcon} from './ProfileImages';
const ProfileComponentModified = () => {
  return (
    <View style={styles.profileContainer}>
      ...
      <View style={styles.profileButtonContainer}>
        <TouchableOpacity style={styles.editButton}>
          <Text style={styles.editButtonText}>{UpdatedProfile.message}</Text>
        </TouchableOpacity>
...
export default ProfileComponentModified;
